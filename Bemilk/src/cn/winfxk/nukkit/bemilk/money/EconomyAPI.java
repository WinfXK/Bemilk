...
public class EconomyAPI extends MyEconomy {
    ...
    public static String getMoneyEconomyAPIName() {
        String string = Bemilk.Companion.getConfig().getString("EconomyAPI-MoneyName");
        return string != null && !string.isEmpty() ? string : Bemilk.Companion.getConfig().getString("MoneyName");
    }
