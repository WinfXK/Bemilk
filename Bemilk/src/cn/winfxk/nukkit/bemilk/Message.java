...
public class Message {
    ...
    static {
        file = new File(Bemilk.Companion.getMain().getDataFolder(), Bemilk.MsgConfigName);
    }

    public Message(Bemilk Bemilk) {
        kis = Bemilk;
    ...
    public String getText(Object object, List<String> Key, List<Object> Data, Player player) {
        ...
        if (player != null) {
            ...
            text = text.replace("{Money}", String.valueOf(Bemilk.Companion.getEconomy().getMoney(player)));
        }
    ...
    public String[] getData() {
        return new String[]{"\n", Server.getInstance().getName(), kis.getName(), Bemilk.Companion.getEconomy().getMoneyName(), time.format(new Date()), date.format(new Date())};
    }
}
