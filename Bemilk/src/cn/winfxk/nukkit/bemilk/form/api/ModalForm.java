...
public class ModalForm extends RootForm {
    ...
    public void resolveResponded(Player player, FormResponseModal data) {
        if (data.getClickedButtonId() == 0) {
            if (dispose1 != null) dispose1.dispose(player);
        } else if (dispose2 != null) dispose2.dispose(player);
    }
